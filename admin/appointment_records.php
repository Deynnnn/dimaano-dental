                            ...
                            <form method='post' action='' style="font-size: 18px;">
                                From: <input style="font-size: 18px;" type='date' class='dateFilter' name='fromDate'
                                    value='<?php if (isset($_POST['fromDate']))
                                        echo $_POST['fromDate']; ?>' required>
                                To: <input style="font-size: 18px;" type='date' class='dateFilter' name='endDate' value='<?php if (isset($_POST['endDate']))
                                    echo $_POST['endDate']; ?>' required>
