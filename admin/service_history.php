...
<div class="container-fluid" id="main-content">
    <div class="row">
        <div class="col-lg-10 ms-auto p-4 overflow-hidden">
            ...
            <div class="col-12">
                <h5 class="mb-4 fw-bold">Monthly Service Aquire</h5>
                <canvas id="applicantChart" width="800" height="250"></canvas>
            </div>
            <div class="">
                            ...
                            while($appointment_data = mysqli_fetch_assoc($appointment)){
                                ...
                                echo<<<data
                                    <div class="card p-3 mb-4 col-12">
                                        <h1 class="card-title m-0 border-bottom">Patient name: <span class="fw-light">$patient_data[first_name] $patient_data[last_name]</span></h1>
                                        <h6 class="card-subtitle ">Amount: <span class="fw-light">$formatedPrice</span>
                                        <br>Date Availed: <span class="fw-light">$created_at</span>
                                        <br>Appointment date: <span class="fw-light">$date</span></h6>
                                    </div>
                                data;
                            }
                        ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#printButton').click(function() {
                var printContents = $('#appointments').html();
                var header = $('#print-header').html();
                var footer = $('#print-footer').html();
                ...
                printWindow.document.write(`
                    ...
                    <body>
                        ...
                        <div id="print-footer" class="d-flex justify-content-between align-items-center">
                            ${footer}
                        </div>
                    </body>
                    </html>
